...
const ATLA = new Set(['three.min.js', 'sw.js', 'build.js', 'pdf.min.js', 'pdf.worker.min.js', 'xlsx.full.min.js', 'jspdf.umd.min.js', 'jspdf.plugin.autotable.min.js', 'tesseract.min.js', 'worker.min.js', 'tesseract-core-simd-lstm.wasm.js']);
